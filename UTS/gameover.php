...
<body>
    <div class="container">
        <div class="row">
            ...
            session_start();
            include 'cek.php';
            echo "<p> Hello, ".$_COOKIE['username'].", Sayang permainan sudah selesai. Semoga kali lain bisa lebih baik.</p>";
            echo "<p> Score Anda :" .$_SESSION['score'];
            echo "<br><a href='logout.php'>Main Lagi</a><br>";
